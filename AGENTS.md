...
Before any Copilot SDK work, read the docs from the url `https://github.com/github/copilot-sdk/blob/main/docs/index.md`. Find the relevant section for your task and read it carefully. The docs are the source of truth for the SDK. Your training data knows nothing about copilot sdk.
